...
Define a function exists_triple():
    ...
    Returns: True if there is a row or column with 3 of the same element, False otherwise
"""
# Start of your code
...
test.test_equals(exists_triple([[0, 0, 1], [1, 0, 0], [0, 1, 0]]), False)
test.test_equals(exists_triple([[0, 1, 0], [1, 0, 1], [0, 1, 0]]), False)
